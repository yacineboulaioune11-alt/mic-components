...
export type SelectWithAttachedDropdownProps<T = string> = {
  value: T | "";
...
export default function SelectWithAttachedDropdown<T = string>({
  value,
  onChange,
  items,
  ...
  placeholder = "",
  disabled,
  id = "select-with-dropdown",
  infoMessage,
}: SelectWithAttachedDropdownProps<T>) {
  ...
  const displayValue = value ? getLabel(value as T) : "";
                    ...
                    return (
                      <MenuItem
                        ...
                        sx={{
                          ...
                          paddingBottom: 1,
                          borderBottom:
                            idx < items.length - 1 ? "1px solid #f1f1f1" : "none",
                          // Selection and hover states baked-in
                          "&.Mui-selected": {
